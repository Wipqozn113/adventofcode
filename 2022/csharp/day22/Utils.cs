...
namespace day22
{
    ...
    {
        public static Cube CreateCube(bool test=false)
        {
            return new Cube();
        }

        public static Grove CreateGrove(bool test=false)
        {
            var map = test ? GetTestMap() : GetMap();
            var path = test ? GetTestPath() : GetPath();
            var grove = new Grove(map, path);
            grove.Width = test ? 16 : 151;
            grove.Height = test ? 12 : 200;
            grove.Path.ForEach(comm => comm.Grove = grove);
        ...
        public static char[,] CreateMap(string mapStr, long width, long height)
        {
            ...
            foreach(var line in lines)
            {
                ...
                // Append spaces if string ends early
                while(col < width)
                {
                    map[row, col] = ' ';
                    col++;
        ...
        public static List<Command> CreatePath(string path)
        {
            ...
            foreach(char p in path)
            {
                ...
                {
                    var stepsCommand = new Command(long.Parse(comm));
                    comm = "";
                    commands.Add(stepsCommand);
                    var rotateCommand = new Command(p);
...
..........#.
        ...
        ......#.";
            ...
            return CreateMap(map, 16, 12);
        }

        public static List<Command> GetTestPath()
        {
            return CreatePath("10R5L5R10L4R5L5");
        }
...
#.......#....#........#..........#....#...........";
            ...
            return CreateMap(map, 151, 200);
        }

        public static List<Command> GetPath()
        {
