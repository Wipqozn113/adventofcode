    ...
    def CreateLeftMovement(self):
        ...
        while len(left) != len(self.flat_shape):
            ...
            for point in self.flat_shape:
                ...
                if point.coord.x < leftmost.coord.x and point.coord.y < leftmost.coord.y:
                    leftmost = point
    ...
    def CreateRightMovement(self):
        ...
        while len(right) != len(self.flat_shape):
            ...
            for point in self.flat_shape:
                ...
                if point.coord.x > rightmost.coord.x and point.coord.y < rightmost.coord.y:
                    rightmost = point
    ...
    def CreateDownMovement(self):
        ...
        while len(down) != len(self.flat_shape):
            ...
            for point in self.flat_shape:
                ...
                if point.coord.x > downmost.coord.x and point.coord.y > downmost.coord.y:
                    downmost = point
